    ...
    .catch(error => {
      ...
      return(
        <div>
          ...
          <button className='btndt' onClick={handleClick}> Train SVHN Dataset without SSLS </button>
          <ToastContainer/>
          ...
          <h2>Accuracy for SVHN Dataset without SSLS</h2><br/>
          ...
          <button className='btndt' onClick={handleClick2}> Train SVHN Dataset with SSLS</button>
          <ToastContainer/>
          ...
          {dataLoaded2 ? (
          <div className='dt2-container'>
          <h2>Accuracy for SVHN Dataset for with SSLS</h2><br/>
