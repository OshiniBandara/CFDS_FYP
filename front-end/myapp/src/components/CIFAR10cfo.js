...
function CIFAR10cfd() {
      ...
      const handleClick = () => {
         setLoading1(true);
         axios.get('http://localhost:5000/normal1').then (response => {
      ...
      const handleClick2 = () => {
        setLoading2(true);
        axios.get('http://localhost:5000/ssls1').then (response => {
           // Parse the JSON response and access the first element
           const outputString = response.data.output[0];
      ...
      return(
        <div>
          ...
          <button className='btndt' onClick={handleClick}> Train CIFAR 10 Dataset without SSLS</button>
          <ToastContainer/>
          ...
          <h2>Accuracy for CIFAR10 Dataset for without SSLS</h2><br/>
          ...
          <button className='btndt' onClick={handleClick2}> Train CIFAR 10 Dataset with SSLS</button>
          <ToastContainer/>
          ...
          {dataLoaded2 ? (
          <div className='dt2-container'>
          <h2>Accuracy for CIFAR10 Dataset for with SSLS</h2><br/>
