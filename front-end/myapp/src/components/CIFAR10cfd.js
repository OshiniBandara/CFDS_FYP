...
function CIFAR10cfd() {
      ...
      const [rows, setRows] = useState([]);
        ...
        const handleClick = () => {
          setLoading(true);
          axios.get('http://localhost:5000/run').then (response => {
      ...
      return(
        <div>
          ...
          <button className='btndt' onClick={handleClick}> Train CIFAR 10 Dataset </button>
          <ToastContainer/>
          ...
          <h2>The Cifar10 dataset will be split into two parts and
          ...
          <div className='dt3-container'>
            ...
            <h3>Catastrophic Forgetting Detected!</h3>
              ...
              <h1> Try Test for CIFAR 10 Dataset </h1>
            )}
          </div>
